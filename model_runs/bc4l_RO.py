...
## STIM Daily Model ##
output_dir=master_location+'model_outputs/bc4l_RO'
# Generate stream  instance
sObj=st.Stream(50000,25,dx=100,bin_size=2000)
# Generate runoff instance
rObj=st.GenerateRunoff(sObj,'emp_rain',random_state='linked',location='British Columbia',window=1,max_rlf=2500)
