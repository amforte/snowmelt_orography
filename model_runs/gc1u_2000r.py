...
## STIM Daily Model ##
output_dir=master_location+'model_outputs/gc1u_2000r'
# Generate stream  instance
sObj=st.Stream(50000,25,dx=100,bin_size=2000)
# # Generate runoff instance
rObj=st.GenerateRunoff(sObj,'emp',random_state='unlinked',location='Greater Caucasus',window=1,max_rlf=2000)
