...
## STIM Daily Model ##
output_dir=master_location+'model_outputs/a4u'
# Generate stream  instance
sObj=st.Stream(50000,25,dx=100,bin_size=2000)
# Generate runoff instance
rObj=st.GenerateRunoff(sObj,'emp',random_state='unlinked',location='Alps',window=1,max_rlf=2500)
# # Generate eroder instance
eObj=st.StimEroder(sObj,4e-3)
# Generate counter instance
cObj=st.StimCounter(1,2.25e6,5000,100)
