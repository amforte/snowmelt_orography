...
ax11.set_xlabel(r'WaterGAP3 Runoff ($\bar{R}$) [mm/day]')
ax11.set_ylabel(r'WaterGAP3 Shape (c$_{R}$) Parameter')
ax11.set_xscale('log')
...
ax12.set_xlabel(r'Scale Estimated from WaterGAP3 Mean (R$_{0}^{*}$)')
ax12.set_ylabel('WaterGAP3 Scale (R$_{0}$) Parameter ')
ax12.set_xlim((0,15))
ax12.set_ylim((0,15))
