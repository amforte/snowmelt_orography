...
im1=ax1.imshow(runoff,extent=(left,right,bottom,top),cmap=cm.nuuk_r,vmin=0,vmax=10,alpha=0.75)
...
ax1.plot([bl1,bl1,br1,br1,bl1],[bb1,bt1,bt1,bb1,bb1],c=gc_col,linewidth=0.75)
